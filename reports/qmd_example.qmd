...
![Horse populations for all provinces in Canada from 1906 - 1972.](../results/horse_pops_plot.png){#fig-horse_pops width=65%}
...
We present the standard deviations in @tbl-sd_horse.
