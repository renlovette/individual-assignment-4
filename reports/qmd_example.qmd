...
We present the standard deviations in @tbl-sd-horse.
...
Additionally, note that in @tbl-sd-horse we consider the sample standard deviation of the number of horses during the same time span as @fig-horse-pops.

![Horse populations for the province with the largest standard deviation](../results/horse_pops_plot_largest_sd.png){#fig-horse-pops-plot-largest-sd width=65%}
